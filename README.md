...
| `05_individual_profile_plots.R` | Generates individual otolith Sr⁸⁷/⁸⁶Sr profiles displayed on 4×3 grids (multiple PDFs). Profiles show all spots for a single fish plotted along distance from otolith core. | `outputs/oto_sr8786_dat_with_brood_year.csv` | `figures/AppS1_FigS1_Individual_otolith_profiles.pdf` |
