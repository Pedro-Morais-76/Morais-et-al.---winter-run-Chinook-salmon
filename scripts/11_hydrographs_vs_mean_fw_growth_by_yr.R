...
b = ggplot(filter(flow_passage, BY %in% yrs), aes(x = broodyr_day)) +
  ...
  geom_text(data = filter(flow_exceed, BY=="2004"),label = paste("", round(flow_8.1[1,2],0), "m3 s-1"), x = 40, y = 390, fontface = "italic") +
  geom_text(data = filter(flow_exceed, BY=="2005"),label = paste("", round(flow_8.1[2,2],0), "m3 s-1"), x = 40, y = 390, fontface = "italic") +
  geom_text(data = filter(flow_exceed, BY=="2006"),label = paste("", round(flow_8.1[3,2],0), "m3 s-1"), x = 40, y = 390, fontface = "italic") +
  geom_text(data = filter(flow_exceed, BY=="2012"),label = paste("", round(flow_8.1[4,2],0), "m3 s-1"), x = 40, y = 390, fontface = "italic") +
  geom_text(data = filter(flow_exceed, BY=="2013"),label = paste("", round(flow_8.1[5,2],0), "m3 s-1"), x = 40, y = 390, fontface = "italic") +
  geom_text(data = filter(flow_exceed, BY=="2014"),label = paste("", round(flow_8.1[6,2],0), "m3 s-1"), x = 40, y = 390, fontface = "italic") ; b
